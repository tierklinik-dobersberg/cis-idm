...
VALUES
    (?, ?, ?, ?, ?, ?, ?, ?, ?)
RETURNING id, username, display_name, first_name, last_name, extra, avatar, birthday, password, totp_secret
`
...
SELECT
    id, username, display_name, first_name, last_name, extra, avatar, birthday, password, totp_secret
FROM
    users
`
